...
class AuthMiddleware {
    public async checkAccessToken(req: IRequestExtended, res: Response, next: NextFunction) {
        try {
            ...
            const { userEmail } = tokenService.verifyToken(accessToken as string, 'access');
    ...
    public async checkRefreshToken(req: IRequestExtended, res: Response, next: NextFunction) {
        try {
            ...
            const { userEmail } = tokenService.verifyToken(refreshToken as string, 'refresh');
    ...
    public async checkActionToken(req: IRequestExtended, res: Response, next: NextFunction) {
        try {
            ...
            const { userEmail } = tokenService.verifyToken(token as string, 'action');
